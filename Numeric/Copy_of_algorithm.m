...
angles = Copy_of_sample_multiple(angles_ori,0);
while(1)
t_obj = Copy_of_TransformationObject([0;1],[0;0],sSize1, sSize2, angles,[1,1,1]);
t_obj.toJSpace()
t_obj.trajGen()
t_obj.toTSpace()
t_obj.computeError();
...
angles = Copy_of_sample_multiple(angles, 1);
