classdef TransformationObject
    ...
    methods
        function obj = TransformationObject(start_end, sampleSize_1, sampleSize_2,angles,arms)
            obj.start_pt,obj.end_pt = start_end
        ...
        function obj = toJSpace(obj)
            ...
            obj.transformed_pts = (transform(obj.original_pts, obj.angles,obj.arms)) %to joint space
        end
        function obj = trajGen(obj)
            %build trajectory from transformed points
            obj.trajectory = (trajectory1(obj.transformed_pts,obj.sampleSize_2)) %in joint space
        end
        function obj = toTSpace(obj)
            obj.transformed_pts = retransform(obj.arms,obj.trajectory) %from joint space to 
        end
        ...
        function plot(obj)
            ...
            ax2 = subplot(2,1,2);
            plot(obj.transformed_pts(1,:),obj.transformed_pts(2,:));
            hold on;
